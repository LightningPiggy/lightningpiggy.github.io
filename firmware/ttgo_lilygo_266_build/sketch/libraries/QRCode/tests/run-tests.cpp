#line 1 "/home/user/wip-LightningPiggy/sources/lightning-piggy/LightningPiggy-Lilygo-266/libraries/QRCode/tests/run-tests.cpp"
#include <iostream>
#include <string>

#include "../src/qrcoded.h"
#include "QrCode.hpp"
...
int main()
{
    ...
    {
        if (LOCK_VERSION != 0 && LOCK_VERSION != version)
        {
            continue;
        }
